...
2025년 10월, Anthropic은 **Claude for Life Sciences**를 출시하면서 PubMed, Benchling, BioRender 등 생명과학 분야에 특화된 MCP 커넥터들을 공개했습니다. 이와 별도로, 커뮤니티와 각 기관에서도 ChEMBL, ClinicalTrials.gov, Open Targets, bioRxiv 등 독립적인 MCP Server를 개발하고 있습니다. 아래에서 대표적인 것들을 소개합니다.


## 1) ToolUniverse

[**ToolUniverse**][1]는 Harvard Medical School의 **Zitnik Lab**에서 개발한 AI scientist 생태계입니다. LLM이 600개 이상의 과학 도구(논문 기준)(ML 모델, 데이터셋, API, 패키지)를 직접 호출할 수 있도록 SMCP(`tooluniverse-smcp-stdio`)를 구현했습니다.
...
[**Open Targets**][2]는 **EMBL-EBI**, **Wellcome Sanger Institute**, **GSK**, **Pfizer** 등 7개 파트너로 구성된 컨소시엄이 운영하는 약물 타겟 발굴 플랫폼입니다. 2026년 1월에 공식 MCP Server를 공개했습니다.
...
[**PubMed**][5]는 NCBI/NLM에서 운영하는 **3,700만 건 이상**의 Biomedical 문헌 검색 엔진입니다.
